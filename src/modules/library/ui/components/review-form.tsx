...
import { StarPicker } from "@/modules/library/ui/components/star-picker";
...
type ReviewFormProps = {
  productId: string;
  initialData?: ReviewGetOneOutput | any;
};
      ...
      >
        ...
        {!isPreview && (
          <Button
            ...
            type="submit"
            size="lg"
            className="bg-black text-white hover:bg-pink-400 hover:text-primary w-full"
          >
